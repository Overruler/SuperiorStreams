...
IOToDoubleBiFunction<A, Integer>> {//*E*
	...
	public <R> RioStream<A, R> flatMap(IOBiFunction<A, Integer, ? extends java.util.stream.Stream<? extends R>> mapper) {
		return flatMapInternal(castToFlatMapFunctions(mapper), cast());
	}
	public final @SafeVarargs <R> RioStream<A, R> flatMap(
		Function<Integer, ? extends java.util.stream.Stream<? extends R>> mapper,
	...
	private <R> Function<Integer, ? extends java.util.stream.Stream<? extends R>> castToFlatMapFunctions(
		IOBiFunction<A, Integer, ? extends java.util.stream.Stream<? extends R>> mapper) {
		return t -> mapper.uncheck(classOfE()).apply(getCached(), t);
	}
