 ...
 * List.of(one, two, three, four, five) method.
 */
final class ListOf5<T> implements List<T> {
	...
	ListOf5(T obj1, T obj2, T obj3, T obj4, T obj5) {
		this.element0 = obj1;
		this.element1 = obj2;
		this.element2 = obj3;
		this.element3 = obj4;
	...
	public @Override String toString() {
		...
		.append(element4 == this ? "(this List)" : String.valueOf(element4))
		.append(']').toString();
		//*E*
	}
	public @Override int hashCode() {
		...
		return 31 * (31 * (31 * (31 * (31 * 1 + code0) + code1) + code2) + code3) + code4;
	}
	public @Override boolean equals(Object otherList) {
		if(otherList == this) {
			return true;
		}
		if(otherList instanceof ListOf5) {
	...
	public @Override List<T> add(T newItem) {
		return List.of(element0, element1, element2, element3, element4, newItem);
	}
	...
	public @Override Object[] toArray() {
		return new Object[] { element0, element1, element2, element3, element4 };
	}
	public @Override T[] toArray(IntFunction<T[]> generator) {
		T[] array = generator.apply(5);
		array[0] = element0;
		array[1] = element1;
		array[2] = element2;
		array[3] = element3;
	...
	public @Override List<T> add(int index, T element) {
		switch(index) {//*Q*
			case -6: case 0: return List.of(element, element0, element1, element2, element3, element4);
			case -5: case 1: return List.of(element0, element, element1, element2, element3, element4);
			case -4: case 2: return List.of(element0, element1, element, element2, element3, element4);
			case -3: case 3: return List.of(element0, element1, element2, element, element3, element4);
			case -2: case 4: return List.of(element0, element1, element2, element3, element, element4);
	...
	public @Override List<T> remove(int index) {
		switch(index) {//*Q*
			case -5: case 0: return List.of(element1, element2, element3, element4);
			case -4: case 1: return List.of(element0, element2, element3, element4);
			case -3: case 2: return List.of(element0, element1, element3, element4);
			case -2: case 3: return List.of(element0, element1, element2, element4);
			case -1: case 4: return List.of(element0, element1, element2, element3);
			default: throw new IndexOutOfBoundsException("Index: " + index + " Size: 5");
		}//*E*
	}
	public @Override List<T> set(int index, T element) {
		switch(index) {//*Q*
			case -5: case 0: return List.of(element, element1, element2, element3, element4);
			case -4: case 1: return List.of(element0, element, element2, element3, element4);
			case -3: case 2: return List.of(element0, element1, element, element3, element4);
			case -2: case 3: return List.of(element0, element1, element2, element, element4);
	...
	public @Override <E extends Exception> double[] mapToDouble(ExToDoubleFunction<? super T, E> doubleFunction)
		...
		return new double[] { doubleFunction.applyAsDouble(element0), doubleFunction.applyAsDouble(element1),
			...
			doubleFunction.applyAsDouble(element4), };
	}
	...
	public @Override Stream<T> stream() {
		return Stream.of(element0, element1, element2, element3, element4);
	}
}
