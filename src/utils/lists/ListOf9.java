...
/**
 * This is a nine element immutable ListOf9 which is created by calling
 * List.of(one, two, three, four, five, six, seven, eight, nine) method.
 */
final class ListOf9<T> implements List<T> {
	...
	ListOf9(T obj1, T obj2, T obj3, T obj4, T obj5, T obj6, T obj7, T obj8, T obj9) {
		this.element0 = obj1;
		this.element1 = obj2;
		this.element2 = obj3;
		this.element3 = obj4;
	...
	public @Override String toString() {
		...
		.append(element8 == this ? "(this List)" : String.valueOf(element8))
		.append(']').toString();
		//*E*
	}
	public @Override int hashCode() {
		...
		//*Q*
		return 31 * (31 * (31 * (31 * (31 * (31 * (31 * (31 * (31 * 1 + code0) + code1) + code2) + code3) + code4) + code5) + code6) + code7) + code8;
		//*E*
	}
	public @Override boolean equals(Object otherList) {
		...
		if(otherList instanceof ListOf9) {
			ListOf9<?> list = (ListOf9<?>) otherList;
			//*Q*
			return
	...
	public @Override T get(int index) {
		switch(index) {//*Q*
			case -9: case 0: return element0;
			case -8: case 1: return element1;
			case -7: case 2: return element2;
			case -6: case 3: return element3;
			case -5: case 4: return element4;
			case -4: case 5: return element5;
			case -3: case 6: return element6;
			case -2: case 7: return element7;
			case -1: case 8: return element8;
	...
	public @Override List<T> add(int index, T element) {
		switch(index) {//*Q*
			case -10: case 0: return List.of(element, element0, element1, element2, element3, element4, element5, element6, element7, element8);
			case  -9: case 1: return List.of(element0, element, element1, element2, element3, element4, element5, element6, element7, element8);
			case  -8: case 2: return List.of(element0, element1, element, element2, element3, element4, element5, element6, element7, element8);
			case  -7: case 3: return List.of(element0, element1, element2, element, element3, element4, element5, element6, element7, element8);
			case  -6: case 4: return List.of(element0, element1, element2, element3, element, element4, element5, element6, element7, element8);
			case  -5: case 5: return List.of(element0, element1, element2, element3, element4, element, element5, element6, element7, element8);
			case  -4: case 6: return List.of(element0, element1, element2, element3, element4, element5, element, element6, element7, element8);
			case  -3: case 7: return List.of(element0, element1, element2, element3, element4, element5, element6, element, element7, element8);
			case  -2: case 8: return List.of(element0, element1, element2, element3, element4, element5, element6, element7, element, element8);
	...
	public @Override List<T> remove(int index) {
		switch(index) {//*Q*
			case -9: case 0: return List.of(element1, element2, element3, element4, element5, element6, element7, element8);
			case -8: case 1: return List.of(element0, element2, element3, element4, element5, element6, element7, element8);
			case -7: case 2: return List.of(element0, element1, element3, element4, element5, element6, element7, element8);
			case -6: case 3: return List.of(element0, element1, element2, element4, element5, element6, element7, element8);
			case -5: case 4: return List.of(element0, element1, element2, element3, element5, element6, element7, element8);
			case -4: case 5: return List.of(element0, element1, element2, element3, element4, element6, element7, element8);
			case -3: case 6: return List.of(element0, element1, element2, element3, element4, element5, element7, element8);
			case -2: case 7: return List.of(element0, element1, element2, element3, element4, element5, element6, element8);
			case -1: case 8: return List.of(element0, element1, element2, element3, element4, element5, element6, element7);
			default: throw new IndexOutOfBoundsException("Index: " + index + " Size: 9");
		}//*E*
	}
	public @Override List<T> set(int index, T element) {
		switch(index) {//*Q*
			case -9: case 0: return List.of(element, element1, element2, element3, element4, element5, element6, element7, element8);
			case -8: case 1: return List.of(element0, element, element2, element3, element4, element5, element6, element7, element8);
			case -7: case 2: return List.of(element0, element1, element, element3, element4, element5, element6, element7, element8);
			case -6: case 3: return List.of(element0, element1, element2, element, element4, element5, element6, element7, element8);
			case -5: case 4: return List.of(element0, element1, element2, element3, element, element5, element6, element7, element8);
			case -4: case 5: return List.of(element0, element1, element2, element3, element4, element, element6, element7, element8);
			case -3: case 6: return List.of(element0, element1, element2, element3, element4, element5, element, element7, element8);
			case -2: case 7: return List.of(element0, element1, element2, element3, element4, element5, element6, element, element8);
	...
	public @Override <E extends Exception> double[] mapToDouble(ExToDoubleFunction<? super T, E> doubleFunction)
		...
		return new double[] { doubleFunction.applyAsDouble(element0), doubleFunction.applyAsDouble(element1),
			...
			doubleFunction.applyAsDouble(element8), };
	}
	public @Override <E extends Exception> int[] mapToInt(ExToIntFunction<? super T, E> intFunction) throws E {
		return new int[] { intFunction.applyAsInt(element0), intFunction.applyAsInt(element1),
			...
			intFunction.applyAsInt(element8), };
	}
	public @Override <E extends Exception> long[] mapToLong(ExToLongFunction<? super T, E> longFunction) throws E {
		return new long[] { longFunction.applyAsLong(element0), longFunction.applyAsLong(element1),
			...
			longFunction.applyAsLong(element8), };
	}
	...
	public @Override Stream<T> stream() {
		return Stream.of(element0, element1, element2, element3, element4, element5, element6, element7, element8);
	}
}
