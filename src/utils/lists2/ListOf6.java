...
/**
 * This is a six element immutable ListOf6 which is created by calling
 * List.of(one, two, three, four, five, six) method.
 */
final class ListOf6<T> implements List<T> {
	...
	ListOf6(T obj1, T obj2, T obj3, T obj4, T obj5, T obj6) {
		this.element0 = obj1;
		this.element1 = obj2;
		this.element2 = obj3;
		this.element3 = obj4;
	...
	public @Override String toString() {
		...
		.append(element5 == this ? "(this List)" : String.valueOf(element5))
		.append(']').toString();
		//*E*
	}
	public @Override int hashCode() {
		...
		return 31 * (31 * (31 * (31 * (31 * (31 * 1 + code0) + code1) + code2) + code3) + code4) + code5;
	}
	public @Override boolean equals(Object otherList) {
		if(otherList == this) {
			return true;
		}
		if(otherList instanceof ListOf6) {
			ListOf6<?> list = (ListOf6<?>) otherList;
			//*Q*
			return
	...
	public @Override T get(int index) {
		switch(index) {//*Q*
			case -6: case 0: return element0;
			case -5: case 1: return element1;
			case -4: case 2: return element2;
			case -3: case 3: return element3;
			case -2: case 4: return element4;
			case -1: case 5: return element5;
			default: throw new IndexOutOfBoundsException("Index: " + index + ", Size: 6");
		}//*E*
	}
	public @Override List<T> add(T newItem) {
		return List.of(element0, element1, element2, element3, element4, element5, newItem);
	}
	...
	public @Override Object[] toArray() {
		return new Object[] { element0, element1, element2, element3, element4, element5 };
	}
	public @Override T[] toArray(IntFunction<T[]> generator) {
		T[] array = generator.apply(6);
		array[0] = element0;
		array[1] = element1;
		array[2] = element2;
		array[3] = element3;
	...
	public @Override List<T> add(int index, T element) {
		switch(index) {//*Q*
			case -7: case 0: return List.of(element, element0, element1, element2, element3, element4, element5);
			case -6: case 1: return List.of(element0, element, element1, element2, element3, element4, element5);
			case -5: case 2: return List.of(element0, element1, element, element2, element3, element4, element5);
			case -4: case 3: return List.of(element0, element1, element2, element, element3, element4, element5);
			case -3: case 4: return List.of(element0, element1, element2, element3, element, element4, element5);
			case -2: case 5: return List.of(element0, element1, element2, element3, element4, element, element5);
	...
	public @Override List<T> remove(int index) {
		switch(index) {//*Q*
			case -6: case 0: return List.of(element1, element2, element3, element4, element5);
			case -5: case 1: return List.of(element0, element2, element3, element4, element5);
			case -4: case 2: return List.of(element0, element1, element3, element4, element5);
			case -3: case 3: return List.of(element0, element1, element2, element4, element5);
			case -2: case 4: return List.of(element0, element1, element2, element3, element5);
			case -1: case 5: return List.of(element0, element1, element2, element3, element4);
			default: throw new IndexOutOfBoundsException("Index: " + index + " Size: 6");
		}//*E*
	}
	public @Override List<T> set(int index, T element) {
		switch(index) {//*Q*
			case -6: case 0: return List.of(element, element1, element2, element3, element4, element5);
			case -5: case 1: return List.of(element0, element, element2, element3, element4, element5);
			case -4: case 2: return List.of(element0, element1, element, element3, element4, element5);
			case -3: case 3: return List.of(element0, element1, element2, element, element4, element5);
			case -2: case 4: return List.of(element0, element1, element2, element3, element, element5);
			case -1: case 5: return List.of(element0, element1, element2, element3, element4, element);
			default: throw new IndexOutOfBoundsException("Index: " + index + " Size: 6");
		}//*E*
	}
	...
	public @Override <E extends Exception> int[] mapToInt(ExToIntFunction<? super T, E> intFunction) throws E {
		return new int[] { intFunction.applyAsInt(element0), intFunction.applyAsInt(element1),
			...
			intFunction.applyAsInt(element5), };
	}
	public @Override <E extends Exception> long[] mapToLong(ExToLongFunction<? super T, E> longFunction) throws E {
		return new long[] { longFunction.applyAsLong(element0), longFunction.applyAsLong(element1),
			...
			longFunction.applyAsLong(element5), };
	}
	...
	public @Override Stream<T> stream() {
		return Stream.of(element0, element1, element2, element3, element4, element5);
	}
}
